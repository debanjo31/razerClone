...
export default function Home() {
  ...
  return (
    <main className='mt-16 md:mt-[80px] z-10 bg-[rgb(37, 37, 37)]'>
      <div className='bg-[rgb(17, 17, 17)] laptop'>
        <p className='text-[rgb(57, 214, 44)]'>LAPTOPS & DESKTOPS</p>
        <p>
          ...
          diverse collection of gamer accessories and PC peripherals, we’ve got
          you covered when it comes to your unique gaming or office desktop
          needs.
        </p>
      </div>
      <div className='bg-[rgb(17, 17, 17)] peripherals'>
        <p className='text-[rgb(57, 214, 44)]'>PC & LAPTOP PERIPHERALS</p>
        <p>
      ...
      <div className='bg-[rgb(17, 17, 17)] content'>
        <p className='text-[rgb(57, 214, 44)]'>CONTENT CREATION & STREAMING</p>
        <p>
      ...
      <div className='bg-[rgb(17, 17, 17)] software'>
        <p className='text-[rgb(57, 214, 44)]'>SOFTWARE</p>
        <p>
